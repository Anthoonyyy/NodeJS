...
console.log('On passe dans controllers/message.controller');
...
exports.create = (req, res) => {
    ...
    //Valider le contenu de la requête ( formulaire a bien été rempli ? )
...
exports.updateById = (req,res) => {
    console.log('Récupérer les données du message' + req.params.id + " avant modification");
    ...
    Message.updateById(req.params.id, (err, data) => {
        if (err){
            ...
            res.render('editMessage', {title: titrePage, donnees: data});
        }
    });
};
...
exports.update = (req,res) => {
    ...
    if ((!req.body)||(lenom=="")||(lemessage=="")) {
        ...
        // Créer un message avec le modèle
        const unMsg = new Message({
            nom: req.body.nom,
            msg: req.body.msg
        });
...
// Supprimer message en fonction de son id
